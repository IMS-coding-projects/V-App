...
function Menubar({ className, value: valueProp, onValueChange: onValueChangeProp, ...props }: MenubarPrimitive.RootProps & React.RefAttributes<MenubarPrimitive.RootRef>) {
...
function MenubarTrigger({ className, ...props }: MenubarPrimitive.TriggerProps & React.RefAttributes<MenubarPrimitive.TriggerRef>) {
    const { value } = MenubarPrimitive.useRootContext();
    const { value: itemValue } = MenubarPrimitive.useMenuContext();

    return (
        <TextClassContext.Provider value={cn('text-sm font-medium select-none group-active:text-accent-foreground', value === itemValue && 'text-accent-foreground')}>
...
function MenubarSubContent({ className, ...props }: MenubarPrimitive.SubContentProps & React.RefAttributes<MenubarPrimitive.SubContentRef>) {
    return (
...
function MenubarLabel({
    ...
    return <MenubarPrimitive.Label className={cn('text-foreground px-2 py-2 text-sm font-medium sm:py-1.5', inset && 'pl-8', className)} {...props} />;
}

function MenubarSeparator({ className, ...props }: MenubarPrimitive.SeparatorProps & React.RefAttributes<MenubarPrimitive.SeparatorRef>) {
