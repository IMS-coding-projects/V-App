...
- Students will understand and implement how routing works in React Native.
...
| ----- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------ |
| A     | Introduce functional programming<br></br>concepts, recap prior knowledge,<br></br> and set up problem context.| Presentation, guided<br></br>discussion, Q and A| PDF exercises 1-1.2,<br></br>Slides  |
| V     | Learn functional decomposition,<br></br> composition and pure functions.<br></br>Understand Pythagoras example<br></br>and its translation into TypeScript. | Reading, code<br></br>walkthroughs, guided<br></br>explanations     | Exercises 2.1.1-2.1.3,<br></br>PDF, VSCode / TypeScript  |
| I     | Apply knowledge by implementing<br></br>functions for Pythagoras sides,<br></br>angles and refactoring code into<br></br>reusable modules.     | Individual coding<br></br>tasks, stepwise<br></br>modeling, step by<br></br>step implementation | Exercises 2.1-2.4,<br></br>TypeScript environment,<br></br>math.ts / main.ts |
| V     | Deepen procedural skills by<br></br>debugging, testing and verifying<br></br> code.     | Self-paced coding,<br></br>paired work,<br></br>guided feedback     | Exercises 2.2-2.4,<br></br>TypeScript environment|
| A     | Consolidate knowledge by reflecting<br></br>on advantages of functional<br></br>programming and documenting<br></br>understanding.     | Reflection exercises,<br></br>glossary entries,<br></br>more portfolio work | Exercise 2.5, Glossary /<br></br>Portfolio       |
