...
If you are familliar with [Next.js](https://nextjs.org), you might have noticed simmilarities, well that is because both Routers basically use the same file-based routing mechanism.
