...
<Update label="19.03.2026" description="Day 7">
  <AccordionGroup>
    <Accordion icon="circle-check" title="What was accomplished today?">
      Today my teammate and I finished the V-App Project. We completed and split up the tutorial and also created a Kahoot so we can evaluate the classes learnings. ([Evalute](http://localhost:3000/lesson-prep#step-11-evaluate-phase-analysis) \<-> Last step from [AVIVA](/lesson-prep#step-12-create-lesson-flow-aviva-model))
    </Accordion>
    <Accordion icon="mountain" title="Were there any challenges you successfully overcame?">
