...
<Update label="05.03.2026" description="Day 3">
  <AccordionGroup>
    ...
    <Accordion icon="mountain" title="Were there any challenges you successfully overcame?">
      Yes. Today there were several challenges, like SVG rendering but also the navigation.
    </Accordion>
    <Accordion icon="route" title="Which steps were essential in solving the challenge?">
...
<Update label="03.03.2026" description="Day 2">
  <AccordionGroup>
    ...
    <Accordion icon="mountain" title="Were there any challenges you successfully overcame?">
      No challenges. It just took time.
    </Accordion>
    <Accordion icon="route" title="Which steps were essential in solving the challenge?">
      _None._
    </Accordion>
...
<Update label="26.02.2026" description="Day 1">
  <AccordionGroup>
    ...
    <Accordion icon="mountain" title="Were there any challenges you successfully overcame?">
      Since it was the first day, there weren't many challenges... Maybe as a challenge is to understand the tech stack. Like what component does what in the whole (metro/expo/uniwind/react native and many more)
    </Accordion>
    <Accordion icon="route" title="Which steps were essential in solving the challenge?">
